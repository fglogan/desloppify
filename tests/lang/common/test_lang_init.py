...
from desloppify.languages.framework.base import DetectorPhase, LangConfig
...
def test_get_lang_rejects_non_dict_legacy_setting_keys():
    ...
    registry_state._registry["_bad_legacy_keys"] = BadLegacySettingKeysConfig
    try:
        with pytest.raises(ValueError, match="legacy_setting_keys must be a dict"):
            get_lang("_bad_legacy_keys")
    finally:
        registry_state._registry.pop("_bad_legacy_keys", None)
