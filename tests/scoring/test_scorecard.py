...
from desloppify.app.output.scorecard_parts.left_panel import draw_left_panel as draw_left_panel_impl
from desloppify.app.output.scorecard_parts.meta import (
    resolve_package_version as resolve_package_version_impl,
)
from desloppify.app.output.scorecard_parts.meta import resolve_project_name as resolve_project_name_impl
from desloppify.app.output.scorecard_parts.right_panel import draw_right_panel as draw_right_panel_impl
...
class TestGetProjectName:
    def test_gh_cli_success(self, monkeypatch):
        from desloppify.app.output import scorecard
...
class TestScorecardDimensionPolicy:
    def test_resolve_scorecard_lang_prefers_latest_scan_history(self):
        ...
        assert _resolve_scorecard_lang(state) == "python"
    ...
    def test_collapse_elegance_dimensions_averages_components(self):
        ...
        collapsed = _collapse_elegance_dimensions(dims, lang_key="python")
    ...
    def test_limit_scorecard_dimensions_python_keeps_contracts_not_type_safety(self):
        ...
        limited = _limit_scorecard_dimensions(
    ...
    def test_prepare_scorecard_dimensions_caps_to_twelve_and_collapses_elegance(self):
        ...
        rows = _prepare_scorecard_dimensions(state)
