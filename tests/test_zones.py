...
class TestClassifyFile:
    ...
    def test_generated_directory(self):
        ...
        assert classify_file("src/generated/types.py", COMMON_ZONE_RULES) == Zone.GENERATED

    def test_dunder_generated_directory(self):
        """File in __generated__/ is classified as GENERATED."""
        assert classify_file("__generated__/schema.py", COMMON_ZONE_RULES) == Zone.GENERATED
    ...
    def test_production_unknown_path(self):
        ...
        assert classify_file("lib/utils/helpers.py", COMMON_ZONE_RULES) == Zone.PRODUCTION
    ...
    def test_override_on_vendor_file(self):
        ...
        assert classify_file("vendor/special.py", COMMON_ZONE_RULES, overrides) == Zone.PRODUCTION
    ...
    def test_override_invalid_zone_falls_through(self):
        ...
        assert classify_file("scripts/run.py", COMMON_ZONE_RULES, overrides) == Zone.SCRIPT
    ...
    def test_override_missing_key_falls_through(self):
        ...
        assert classify_file("src/app.py", COMMON_ZONE_RULES, overrides) == Zone.PRODUCTION
