"""Tests for desloppify.engine.detectors.passthrough — tier classification and param classification."""
...
class TestClassifyParams:
    ...
    def test_occurrences_per_match_default(self):
        ...
        pt, direct = classify_params(
            ["x"],
            body,
            lambda name: rf"\b\w+\({re.escape(name)}\)",
