...
from desloppify.app.commands.move.move_apply import safe_write
...
class TestResolveMoveVerifyHint:
    """resolve_move_verify_hint supports modern and legacy move module APIs."""
    ...
    def test_falls_back_to_legacy_constant(self):
        move_mod_api = SimpleNamespace(VERIFY_HINT="npx tsc --noEmit")
        assert resolve_move_verify_hint(move_mod_api) == "npx tsc --noEmit"
