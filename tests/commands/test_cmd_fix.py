"""Tests for desloppify.app.commands.fix_cmd — fix command helpers."""

from desloppify.app.commands import fix_cmd as fix_cmd_mod
from desloppify.app.commands.fix_cmd import (
    _SKIP_REASON_LABELS,
    _print_fix_retro,
    _print_fix_summary,
...
class TestFixModuleSanity:
    ...
    def test_fix_review_is_not_special_alias(self, monkeypatch):
        ...
        import desloppify.app.commands.fix_cmd as fix_mod
...
class TestResolveFixerResults:
    ...
    def test_resolves_matching_open_findings(self, monkeypatch):
        monkeypatch.setattr(fix_cmd_mod, "rel", lambda p: p)
...
class TestFixNarrativeReminders:
    def test_report_dry_run_uses_fix_dry_run_command_and_prints_reminders(self, monkeypatch, capsys):
        ...
        import desloppify.app.commands._helpers as helpers_mod
        import desloppify.app.commands.fix_cmd as fix_mod
