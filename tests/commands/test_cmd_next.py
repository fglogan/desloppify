...
class TestCmdNextOutput:
    def test_requires_prior_scan(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(next_mod, "_write_query", _should_not_run)
    ...
    def test_tier_navigator_always_printed(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            next_mod, "_write_query", lambda payload: written.append(payload)
        )
        monkeypatch.setattr(
            next_mod,
            "build_work_queue",
    ...
    def test_subjective_focus_and_review_prepare_hint(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(next_mod, "_write_query", lambda _payload: None)
        monkeypatch.setattr(
            next_mod,
            "build_work_queue",
            lambda *_a, **_k: {
