"""Tests for desloppify.app.commands.show — helper/formatting functions."""
...
from desloppify.app.commands import show as show_mod
from desloppify.app.commands.helpers.runtime import CommandRuntime
from desloppify.app.commands.show import (
    _DETAIL_DISPLAY,
    _build_show_payload,
    _format_detail,
...
class TestShowSubjectiveFollowup:
    def test_penalty_state_prints_warning_and_next_step(self, capsys):
        ...
        _show_subjective_followup(state, 95.0)
...
class TestCmdShowBackendIntegration:
    def _patch_common(self, monkeypatch, *, state):
        ...
        monkeypatch.setattr(show_mod, "resolve_lang", lambda _args: None)
    ...
    def test_show_uses_shared_queue_for_pattern_filter(self, monkeypatch, capsys):
        ...
        calls = []
        monkeypatch.setattr(show_mod, "_write_query", lambda _payload: None)
        ...
        monkeypatch.setattr(show_mod, "build_work_queue", fake_queue)
