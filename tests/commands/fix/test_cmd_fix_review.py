...
from desloppify.app.commands.fix_cmd import _cmd_fix_review, cmd_fix
...
_P_LANG = "desloppify.app.commands.fix_cmd.resolve_lang"
_P_SP = "desloppify.app.commands.fix_cmd.state_path"
_P_LOAD = "desloppify.state.load_state"
_P_PREP = "desloppify.intelligence.review.prepare_review"
_P_SETUP = "desloppify.app.commands.review.cmd._setup_lang"
_P_WQ = "desloppify.app.commands.fix_cmd._write_query"
...
class TestFixReviewInterception:
    ...
    def test_review_dispatched(self):
        ...
        args.fixer = "review"
        args.dry_run = False
        with patch("desloppify.app.commands.fix_cmd._cmd_fix_review") as mock_review:
            cmd_fix(args)
