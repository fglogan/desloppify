...
from desloppify.engine.state_internal.merge import upsert_findings
...
class TestWontfixAutoResolution:
    ...
    def test_wontfix_resolved_when_detector_ran(self):
        ...
        diff = merge_scan(
            st, [], lang="python", potentials={"test_coverage": 50, "smells": 100}
        )
    ...
    def test_wontfix_not_resolved_when_detector_suspect(self):
        ...
        diff = merge_scan(st, [], lang="python", potentials={"smells": 100})
    ...
    def test_wontfix_resolved_when_some_findings_remain(self):
        ...
        _ = merge_scan(st, current, lang="python", potentials={"test_coverage": 50})
...
class TestSuppressionAccounting:
    def test_merge_scan_records_ignored_metrics_in_history_and_diff(self):
        ...
        diff = merge_scan(
            st, findings, lang="python", ignore=["smells::*"], force_resolve=True
        )
...
class TestScoreAntiGaming:
    ...
    def test_manual_fixed_does_not_improve_verified_until_scan_confirms(self):
        from desloppify.state import merge_scan, resolve_findings
    ...
    def test_ignore_pattern_does_not_remove_score_penalty(self):
        from desloppify.state import merge_scan, remove_ignored_findings
