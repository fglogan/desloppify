...
def create_parser() -> argparse.ArgumentParser:
    ...
    p_status.add_argument("--include-suppressed", action="store_true",
    ...
    p_show.add_argument("--include-suppressed", action="store_true",
    ...
    p_ignore.add_argument("--note", type=str, default=None, help="Reason for suppressing this pattern (required)")
